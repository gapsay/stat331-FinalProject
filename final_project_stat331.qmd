...
Although unrealistic, when $log_{10}(GDP\space per\space capita)$ is equal to zero, the intercept of `r round(models$estimate[1], 2)` represents the predicted life expectancy. 
...
Although unrealistic, when $\log_{10}(GDP\space per\space capita)$ is equal to zero, the intercept of `r round(models$estimate[3], 2)` represents the predicted life expectancy. 
...
Although unrealistic, when $\log_{10}(GDP\space per\space capita)$ is equal to zero, the intercept of `r round(models$estimate[5], 2)` represents the predicted life expectancy. 
...
Although unrealistic, when $\log_{10}(GDP\space per\space capita)$ is equal to zero, the intercept of `r round(models$estimate[7], 2)` represents the predicted life expectancy. 
...
Although unrealistic, when $\log_{10}(GDP\space per\space capita)$ is equal to zero, the intercept of `r round(models$estimate[9], 2)` represents the predicted life expectancy. 
...
Although unrealistic, when $\log_{10}(GDP\space per\space capita)$ is equal to zero, the intercept of `r round(models$estimate[11], 2)` represents the predicted life expectancy. 
:::
...
From the graphs above, it can be seem that both the observed and the simulated data have a positive, linear relationship between life expectancy and $\log_{10}(GDP\space per\space capita)$
