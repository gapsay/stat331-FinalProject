...
gdplex_mod <- lm(avg_life_expectancy ~ avg_gdp, data = gdp_lex_mean) # note we have this already in gdp_lex_lm
...
ggplot(full_data,
  ...
  scale_color_manual(values = continent_colors) +
  theme_minimal() +
  labs(title = "Average GDP per Capita vs Observed Average Life Expectancy",
       x = "GDP per Capita (log scale)",
       y = "",
...
ggplot(full_data,
  ...
  scale_color_manual(values = continent_colors) +
  theme_minimal() +
  labs(title = "Average GDP per Capita vs Simulated Average Life Expectancy",
       x = "GDP per Capita (log scale)",
       y = "",
...
ggplot(full_data,
  ...
  facet_wrap(~Continent, nrow = 2) +
  geom_point(alpha = 0.4, aes(x = avg_gdp,
                     y = life_expectancy)) +
  geom_point(alpha = 0.4, aes(x = avg_gdp,
                     y = sim_gdplex,
                     color = "black")) +
  ...
  scale_color_manual(values = continent_colors) +
  theme_minimal() +
  labs(title = "Average GDP per Capita vs Observed Average Life and Simulated Expectancy Per Continent",
       x = "GDP per Capita (log scale)",
       y = "",
       subtitle = "Observed Life Expectancy (years)") +
  theme(
