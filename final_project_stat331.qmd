...
pop_raw <- read.csv("../stat331-FinalProject/GM-Population - Dataset - v7 - data-for-countries-etc-by-year.csv")
...
# Join the population data set
# gdp_lex_with_continents_pop <- gdp_lex_with_continents |>
#   mutate(year = as.numeric(year)) |>
#   full_join(pop_raw |> mutate(time = as.numeric(time)),
#             join_by("year" == "time", country == name)) |>
